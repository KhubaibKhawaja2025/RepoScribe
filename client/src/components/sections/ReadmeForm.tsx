    ...
    <Card className="p-6 sm:p-8">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-zinc-500">
          Fill in the basics. Preview updates when you generate—no API calls
          yet.
        </p>
      </div>
  ...
  >
    {isImporting ? "Importing Repository..." : "Import Repository"}
        ...
        <Textarea
          ...
          onChange={(e) => patch({ installation: e.target.value })}
        />
        ...
        <Select
          ...
          value={value.tone}
          onChange={(e) =>
            patch({ tone: e.target.value as ReadmeFormData["tone"] })
          }
        >
